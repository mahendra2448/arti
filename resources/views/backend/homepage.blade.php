...
<div class="card">
    <div class="card-body">
        <div class="row">
            <div class="col-sm-5">
                <h4 class="card-title mb-0">Homepage Header</h4>
            </div>
            <div class="col-sm-7">
                                    ...
                                    <div class="container">
                                        <form action="{{ route('admin.home.header.upload') }}" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="custom-upload">
                                                <input type="file" id="foto" name="image" class="form-control" accept="image/jpg, image/jpeg, image/png" required hidden>
