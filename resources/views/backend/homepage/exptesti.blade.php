...
@section('title', __('Home Exp & Testi'))
...
<div class="card">
    <div class="card-body">
        <div class="row">
            <div class="col-sm-5">
                <h4 class="card-title mb-0"><i class="fas fa-image mr-2"></i> Experiences Thumbnails</h4>
            </div>
            <div class="col-sm-7">
                        ...
                        <div class="modal-dialog modal-lg modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="container">
                                        <form action="{{ route('admin.home.exp.exp-upload') }}" method="POST" enctype="multipart/form-data">
                                            @csrf
                    ...
                    <table id="commonTable" class="table table-hover">
                        ...
                        <tbody>
                            @php
                                ...
                                foreach($exp as $e){
                                    $count  = $count + 1;
                                    $img    = $e->image==='' ? url('/storage/z_other_case/img-not-found.png') : $e->image;
                            @endphp
                            <tr>
                                ...
                                <td style="vertical-align: middle;">{{$e->heading_text}}</td>
                                <td class="text-center" style="vertical-align: middle;">
                                    <a class="btn btn-sm btn-primary btn-edit" href="#" data-id="{{$e->id}}" data-toggle="modal" data-target="#editRow"><i class="fas fa-pen mr-2"></i>Edit</a>
                                    <a class="btn btn-sm btn-danger expthumb-delete" href="#" data-id="{{$e->id}}"><i class="fas fa-trash mr-2"></i> Delete</a>
                                </td>
